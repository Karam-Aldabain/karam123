...
/** ---------------- THEME (from new file with pink accent) ---------------- */
const THEME = {
    deep: "#0B1220",
    slate: "#1E2A3A",
    sand: "#E9E7DF",
...
function FormWizard() {
    ...
    const validatePartnership = () => {
        ...
        if (partnership.collab.includes("Other (Specify)") && !partnership.collabOther?.trim())
            errs.collabOther = "Please specify the other collaboration type";
                                ...
                                >
                                    <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
                                        ...
                                        >
                                            ...
                                            />
                                            {fieldErrors.collabOther && (
                                                <FieldError error={fieldErrors.collabOther} />
                                            )}
                                        </Field>
