...
function SnapshotItem({ label, value, icon: Icon, tint = "rgba(255,255,255,0.08)" }) {
  return (
    
    <div className="flex items-start gap-3">
      <div
        className="grid h-1
        '0 w-10 place-items-center rounded-2xl ring-1 ring-white/20"
          ...
          <div className="lg:col-span-5">
            <div className="overflow-hidden rounded-[18px] bg-black/20 ring-1 ring-white/15">
              <div className="relative h-[260px] w-full sm:h-[320px]">
                <img
                  src={meta.heroImage}
                  alt="AI and machine learning team analyzing model performance dashboards"
  ...
  const data = useMemo(
    () => ({
      ...
      hero: {
        ...
        title2: "Build Real Intelligent Systems",
        subtitle:
          "Develop practical AI and machine learning capabilities through a structured internship guided by industry professionals from leading European technology companies.\n\nThis internship simulates modern data and ML team workflows and focuses on building deployable, business-relevant models.",
        tracks: ["Machine Learning", "Applied AI", "MLOps Foundations"],
      },
      ...
      heroMeta: {
        ...
        ink: "#1F2937",
        breadcrumb: ["Home", "For Individuals", "AI & Machine Learning"],
        ratingValue: 5,
        ceus: "EARN 2.0 EEUs",
        heroImage:
      ...
      overview: [
        "Modern AI work requires more than model training. Professionals must understand data pipelines, model evaluation, bias risks, and how to ship reliable ML solutions.",
        "This internship provides a structured environment where participants solve real AI use cases while learning how professional teams build, evaluate, and operationalize models.",
        "Guided by experienced industry professionals, participants complete a comprehensive ML project from problem framing to deployment-ready delivery.",
        "Throughout the program, participants apply practical workflows including data preparation, feature engineering, experimentation, model comparison, and structured reporting.",
        "The program is designed to bridge the gap between academic learning and real-world AI implementation environments.",
      ],

      workOn: {
        intro: "The internship revolves around building a complete AI solution as the central project.",
        types: [
          "Predictive analytics projects",
          "Classification and recommendation systems",
          "NLP and text intelligence workflows",
          "Computer vision mini-cases",
          "Business intelligence with ML insights",
          "MLOps-ready model serving pipelines",
        ],
        tracks: ["Machine Learning", "Applied AI", "MLOps Foundations"],
        emphasis: "The emphasis is on building practical, explainable, and production-minded AI systems.",
      },

      benefits: [
        {
          icon: Rocket,
          title: "Real AI Project Experience",
          desc: "Participants work on an end-to-end AI project that simulates real-world ML delivery environments.",
        },
        {
          icon: GitBranch,
          title: "Professional AI Portfolio",
          desc: "Each participant builds a portfolio including:",
          bullets: ["Model notebook and experiments", "Evaluation report and metrics", "Deployment-ready artifacts", "Business impact summary"],
        },
        {
          icon: Sparkles,
          title: "AI-Assisted Model Evaluation",
          desc: "AI tools support model quality checks, experiment analysis, and documentation feedback throughout the program.",
        },
        {
          icon: ShieldCheck,
          title: "Tooling & Workflow Exposure",
          desc: "Participants gain guided exposure to modern AI tooling workflows used in industry teams.",
        },
        {
          icon: GraduationCap,
          title: "AI Interview Preparation",
          desc: "The program includes practical interview simulations for data, ML, and AI analyst/engineer roles.",
        },
      ],
      ...
      howItWorks: [
        {
          phase: "Phase 1",
          title: "Problem Framing & Dataset Scope",
          bullets: ["Define business/AI objective", "Identify data sources", "Set technical scope"],
          icon: HelpCircle,
        },
        {
          phase: "Phase 2",
          title: "Data & Model Design",
          bullets: ["Design data pipeline", "Select baseline models", "Define evaluation criteria"],
          icon: Layers,
        },
        {
          phase: "Phase 3",
          title: "Model Development",
          bullets: ["Feature engineering", "Model training and tuning", "Error analysis", "Iteration cycles"],
          icon: Code2,
        },
        {
          phase: "Phase 4",
          title: "Validation & Reliability",
          bullets: ["Cross-validation and benchmarking", "Bias and drift checks", "Performance optimization", "Model validation"],
          icon: Database,
        },
        {
          phase: "Phase 5",
          title: "Deployment & AI Presentation",
          bullets: ["Prepare deployment handoff", "Present model decisions", "Explain metrics and tradeoffs", "Discuss production considerations"],
          icon: Cloud,
        },
      ],

      programTakeaways: [
        "Experience building end-to-end AI workflows",
        "A professional AI and ML portfolio",
        "Understanding of model selection, evaluation, and tradeoffs",
        "Experience with collaborative AI development workflows",
        "Exposure to practical MLOps fundamentals",
        "Practical preparation for AI/ML interviews",
        "Structured performance evaluation based on real project work",
      ],

      learningOutcomes: [
        "Frame business problems into ML tasks",
        "Build and evaluate machine learning models with robust metrics",
        "Prepare clean datasets and engineered features for training",
        "Document experiments and model decisions clearly",
        "Collaborate within practical AI project workflows",
        "Communicate AI outcomes to technical and non-technical stakeholders",
      ],

      whoShouldApply: [
        "Final-year university students in computer science or related fields",
        "Recent graduates pursuing AI/ML careers",
        "Early-career professionals seeking structured practical experience",
        "Individuals with basic Python/data knowledge looking to build real AI projects",
      ],
      ...
      programStructure: [
        ...
        { label: "Final Outcome", value: "Portfolio-Ready AI Project" },
      ],

      finalDeliverables: [
        "Trained and evaluated ML model package",
        "Experiment tracking and performance report",
      ...
      whyPraktix: {
        ...
        paragraphs: [
          ...
          "Participants develop practical skills by working on real AI implementation challenges while receiving guidance from industry professionals.",
        ],
      },

      cta: {
        title: "Start Building Real AI Solutions",
          ...
          {openSection === "overview" && (
            <div className="space-y-4">
              <SectionTitle
                ...
                title="Why attend Praktix AI & Machine Learning Internship?"
                subtitle="A structured, professional environment for building practical AI systems end-to-end."
              />
          ...
          {openSection === "work" && (
            <div className="space-y-4">
              <SectionTitle
                ...
                subtitle="A complete AI workflow built through real implementation practices."
              />
              <div className="grid gap-4 lg:grid-cols-12">
          ...
          {openSection === "how" && (
            <div className="space-y-4">
              <SectionTitle
                ...
                subtitle="A structured execution framework based on professional AI/ML workflows."
              />
              ...
              <div className="grid gap-4 lg:grid-cols-12">
                ...
                <Card className="lg:col-span-5">
                  ...
                  <div className="mt-3 text-sm leading-relaxed text-white/70">
                    You’ll be evaluated based on real project work, model quality, documentation clarity, and your
                    ability to communicate AI decisions—ending with portfolio-ready AI assets.
                  </div>
                </Card>
              </div>
            </div>
          ...
          <Card className="relative overflow-hidden p-6 sm:p-8">
            ...
            <div className="relative z-10 flex flex-col gap-6">
              ...
              <div className="text-sm leading-relaxed text-white/75 sm:max-w-3xl">
                Build a practical AI solution, receive structured expert feedback, and graduate with artifacts
                that AI hiring teams can evaluate directly.
              </div>
