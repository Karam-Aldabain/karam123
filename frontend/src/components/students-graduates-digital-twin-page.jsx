          ...
          <div className="lg:col-span-5">
            <div className="overflow-hidden rounded-[18px] bg-black/20 ring-1 ring-white/15">
              <div className="relative h-[260px] w-full sm:h-[320px]">
                <img
                  src={meta.heroImage}
                  alt="Engineers reviewing a digital twin model with industrial dashboards"
...
export default function PraktixInternshipProgramPage() {
  ...
  const data = useMemo(
    () => ({
      ...
      hero: {
        title: "Digital Twin Engineering Internship",
        title2: "Model Real Systems Virtually",
        subtitle:
          "Develop practical digital twin capabilities through a structured internship guided by industry professionals from leading European technology companies.\n\nThis internship simulates modern engineering workflows and focuses on modeling, simulation, and data-driven optimization of real systems.",
        tracks: ["Industrial Digital Twins", "IoT & Sensor Data", "Simulation & Optimization"],
      },
      ...
      heroMeta: {
        ...
        ink: "#1F2937",
        breadcrumb: ["Home", "For Individuals", "Digital Twin"],
        ratingValue: 5,
        ceus: "EARN 2.0 EEUs",
        heroImage:
          "https://images.unsplash.com/photo-1581093588401-16ecf2f6af84?auto=format&fit=crop&w=1400&q=80",
        infoRow: [
      ...
      overview: [
        "Modern digital twin engineering requires more than visualization. Professionals must connect physical systems with data, build simulation logic, and generate actionable operational insights.",
        "This internship provides a structured environment where participants model real-world systems while learning how professional teams design, validate, and optimize digital twins.",
        "Guided by experienced industry professionals, participants complete a comprehensive engineering project from system mapping to simulation outcomes.",
        "Throughout the program, participants apply practical workflows including data integration, model calibration, scenario analysis, and technical documentation.",
        "The program is designed to bridge the gap between academic learning and real-world industrial engineering environments.",
      ],

      workOn: {
        intro: "The internship revolves around building a complete digital twin solution as the central project.",
        types: [
          "Smart manufacturing system twins",
          "Predictive maintenance simulation cases",
          "Energy optimization twin scenarios",
          "IoT-driven process monitoring models",
          "Asset performance digital replicas",
          "Operational decision-support simulations",
        ],
        tracks: ["Industrial Digital Twins", "IoT & Sensor Data", "Simulation & Optimization"],
        emphasis: "The emphasis is on building accurate, practical, and decision-ready digital twin systems.",
      },

      benefits: [
        {
          icon: Rocket,
          title: "Real Digital Twin Project Experience",
          desc: "Participants work on a full digital twin project that simulates real-world industrial engineering environments.",
        },
        {
          icon: GitBranch,
          title: "Professional Digital Twin Portfolio",
          desc: "Each participant builds a portfolio including:",
          bullets: ["System mapping document", "Twin model design", "Simulation reports", "Optimization recommendations"],
        },
        {
          icon: Sparkles,
          title: "AI-Assisted Model Evaluation",
          desc: "AI tools support model consistency checks, scenario analysis, and structured documentation feedback throughout the program.",
        },
        {
          icon: ShieldCheck,
          title: "Industry Tooling Exposure",
          desc: "Participants gain guided exposure to modern digital engineering and simulation workflows used in industry.",
        },
        {
          icon: GraduationCap,
          title: "Engineering Interview Preparation",
          desc: "The program includes practical interview simulations for digital twin, simulation, and smart systems roles.",
        },
      ],
      ...
      howItWorks: [
        {
          phase: "Phase 1",
          title: "System Mapping & Scope",
          bullets: ["Define system boundary", "Identify critical variables", "Set engineering scope"],
          icon: HelpCircle,
        },
        {
          phase: "Phase 2",
          title: "Data Capture & Twin Design",
          bullets: ["Define sensor/data inputs", "Design twin architecture", "Map physical-to-digital relationships"],
          icon: Layers,
        },
        {
          phase: "Phase 3",
          title: "Modeling & Simulation",
          bullets: ["Build simulation model", "Configure operational scenarios", "Run baseline tests", "Iterate model logic"],
          icon: Code2,
        },
        {
          phase: "Phase 4",
          title: "Validation & Optimization",
          bullets: ["Validate against expected behavior", "Tune model parameters", "Analyze bottlenecks", "Recommend optimizations"],
          icon: Database,
        },
        {
          phase: "Phase 5",
          title: "Presentation & Deployment Strategy",
          bullets: ["Present twin insights", "Explain modeling decisions", "Define deployment pathway", "Discuss implementation constraints"],
          icon: Cloud,
        },
      ],

      programTakeaways: [
        "Experience building practical digital twin systems",
        "A professional digital twin engineering portfolio",
        "Understanding of simulation and system behavior modeling",
        "Experience with data-driven engineering workflows",
        "Exposure to practical industrial optimization use-cases",
        "Practical preparation for digital engineering interviews",
        "Structured performance evaluation based on real project work",
      ],

      learningOutcomes: [
        "Map physical systems into digital twin models",
        "Build and run simulation scenarios for decision support",
        "Integrate data inputs to improve model realism",
        "Document modeling assumptions and engineering decisions",
        "Collaborate within structured engineering project workflows",
        "Explain simulation outcomes to technical and business stakeholders",
      ],

      whoShouldApply: [
        "Final-year university students in computer science or related fields",
        "Recent graduates pursuing digital engineering or smart manufacturing careers",
        "Early-career professionals seeking structured practical experience",
        "Individuals with basic engineering/data skills looking to build real digital twin projects",
      ],
      ...
      programStructure: [
        ...
        { label: "Final Outcome", value: "Portfolio-Ready Digital Twin Project" },
      ],

      finalDeliverables: [
        "Digital twin model package",
        "Simulation and scenario analysis report",
        "System mapping and data architecture documentation",
        "Optimization recommendation brief",
        "Digital engineering portfolio artifacts",
      ...
      whyPraktix: {
        ...
        paragraphs: [
          ...
          "Participants develop practical skills by working on real industrial engineering challenges while receiving guidance from industry professionals.",
        ],
      },

      cta: {
        title: "Start Building Real Digital Twin Solutions",
          ...
          {openSection === "overview" && (
            <div className="space-y-4">
              <SectionTitle
                ...
                title="Why attend Praktix Digital Twin Engineering Internship?"
                subtitle="A structured, professional environment for building practical digital twin solutions end-to-end."
              />
          ...
          {openSection === "work" && (
            <div className="space-y-4">
              <SectionTitle
                ...
                subtitle="A complete digital twin system built through real engineering practices."
              />
              <div className="grid gap-4 lg:grid-cols-12">
          ...
          {openSection === "how" && (
            <div className="space-y-4">
              <SectionTitle
                ...
                subtitle="A structured execution framework based on professional digital engineering workflows."
              />
              ...
              <div className="grid gap-4 lg:grid-cols-12">
                ...
                <Card className="lg:col-span-5">
                  ...
                  <div className="mt-3 text-sm leading-relaxed text-white/70">
                    You’ll be evaluated based on real project work, modeling quality, documentation clarity, and your
                    ability to communicate engineering decisions—ending with portfolio-ready digital twin assets.
                  </div>
                </Card>
              </div>
            </div>
          ...
          <Card className="relative overflow-hidden p-6 sm:p-8">
            ...
            <div className="relative z-10 flex flex-col gap-6">
              ...
              <div className="text-sm leading-relaxed text-white/75 sm:max-w-3xl">
                Build a practical digital twin solution, receive structured expert feedback, and graduate with artifacts
                that engineering hiring teams can evaluate directly.
              </div>
